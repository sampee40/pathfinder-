...
function preload(){
 ...
 // giraffee1img = loadImage("giraffblack.png")
  ...
  jungle2img = loadImage("images/jungle3.jpg");
  jungle3img = loadImage("images/jungle5.jpg")
  jungle2img.scale = 1.3;
keysound = loadSound("images/key received.wav")
//timersound =loadSound("images/questiontimer.mp3")
mathslevelsound = loadSound("images/complete.wav")
sciencesound = loadSound("images/new level(2).wav");
key2 = loadImage("images/key2.png")
dashboard = loadImage("images/dashboard.jpg");
